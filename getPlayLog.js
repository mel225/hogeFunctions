if(location.href.indexOf("https://chunithm-net.com/mobile/") == -1 || location.href.indexOf("error") != -1){
  if(confirm("CHUNITHM.NET を開きます。\nログインしてください。")){
    location.href = "https://chunithm-net.com/mobile/";
  }
}else{
  var UserData = {};
...
function getFriendCode(){
  return new Promise(resolve=>{
    var url = "https://chunithm-net.com/mobile/friend/search/";
